...
ORACLE_SYSTEM = (
    ...
    "и оттенок стекла шара (ball_tint_modifier) в единую метафору. Оттенок задаёт эмоциональную "
    "модуляцию тона: не называй его в лоб как краску и не говори «шар зелёный», "
    "а дай почувствовать его психологический смысл. Не называй проценты батареи.\n"
    ...
    "7. ФИНАЛ: После основного текста отдельной строкой напиши маркер [[ИТОГ]] и сразу за ним "
