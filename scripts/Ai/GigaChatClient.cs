...
public sealed class GigaChatClient : IDisposable
{
    ...
    public const string SystemPrompt =
        ...
        "5. ЛОГИКА СВЯЗЕЙ: Незаметно вплети погоду, заряд смартфона, палитру фото и слово-якорь в единую метафору.\n" +
        "6. ФИНАЛ: После основного текста отдельной строкой выдай ключевую фразу строго в формате [[ИТОГ]] ваша фраза " +
        "без кавычек и без слова «итог» внутри самой фразы.";
