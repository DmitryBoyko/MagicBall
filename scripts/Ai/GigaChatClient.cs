...
public sealed class GigaChatClient : IDisposable
{
    ...
    public const string SystemPrompt =
        ...
        "как краску и не говори «шар зелёный», а дай почувствовать его психологический смысл. Не называй проценты батареи.\n" +
        ...
        "7. ФИНАЛ: После основного текста отдельной строкой напиши маркер [[ИТОГ]] и сразу за ним ключевую фразу " +
