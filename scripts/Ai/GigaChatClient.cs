...
public sealed class GigaChatClient : IDisposable
{
    ...
    public const string SystemPrompt =
        ...
        "населённый пункт и/или погода, заряд/состояние устройства, образ или палитра фото, слово-якорь, " +
        "оттенок стекла шара (ball_tint_modifier), ритм обращений (inquiry_pulse_aura). Остальное — лёгкая модуляция. " +
